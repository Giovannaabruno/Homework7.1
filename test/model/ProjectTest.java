...
public class ProjectTest {
  ...
  /**
   *Tester for resetProject.
   */
  @Test
  public void resetProject() {
    Project image = new Project(800, 600);
    image.addLayerFromImage("images/Koala.jpg");
    image.resetProject(900, 900);
    assertEquals(image.getNumberLayers(), 1);
    assertEquals(image.getWidth(), 900);

    Project image2 = new Project(800, 600);
    image2.addLayerFromImage("images/Koala.png");
    image2.resetProject(100, 100);
    assertEquals(image2.getNumberLayers(), 1);
    assertEquals(image2.getWidth(), 100);
