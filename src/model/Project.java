...
public class Project implements ProjectInterface {
  /**
   * stores data for layer.
   */
  private ArrayList<Layer> layers;
  /**
   * stores data for width.
   */
  private int width;
  /**
   * stores data for height.
   */
  private int height;
  ...
  /**
   * Methode resetProject, restes the project to it orginal from.
   * @param height equals height
   * @param width equals width
   */
  public void resetProject(int height, int width) {
    this.width = width;
    this.height = height;
    layers = new ArrayList<Layer>();
    layers.add(new Layer(height, width, "background"));
